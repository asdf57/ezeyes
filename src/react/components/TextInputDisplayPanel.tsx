...
const TextInputDisplayPanel: React.FC<TextInputProps> = ({ style }) => {
  ...
  if (style == null) {
    style = { 'fontSize': settings.panels.textInputPanel.appearance.fontSize } as React.CSSProperties
  } else if (style.fontSize == null) {
    style['fontSize'] = settings.panels.textInputPanel.appearance.fontSize;
  }
